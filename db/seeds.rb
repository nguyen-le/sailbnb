ActiveRecord::Base.transaction do
  ...
  b3 = Boat.new( name: 'Tesla Model Y', lat: 37.4312, long: -122.0601, price: '1600', style: 'Budget', size: 8, user_id: 4, tagline: 'Clean, efficient, luxurious')
  ...
  b4 = Boat.new( name: 'LuthorYacht', lat: 37.4643, long: -122.1113, price: '5000', style: 'Luxury', size: 10, user_id: 15, tagline: 'The Crusher')
  ...
  b5 = Boat.new( name: "Gatsby's", lat: 37.5215, long: -122.2280, price: '4000', style: 'Luxury', size: 10, user_id: 14, tagline: "Always a party at Gatsby's", featured: true)
  ...
  b6 = Boat.new( name: "BatmoYacht", lat: 37.6059, long: -122.4999, price: '1000', style: 'Luxury', size: 4, user_id: 11, tagline: "I am the dark shark", featured: true)
  ...
  b7 = Boat.new( name: "Ruby on Sails", lat: 37.7613, long: -122.3832, price: '18000', style: 'Luxury', size: 40, user_id: 9, tagline: "Learn you a ruby, for great good!", featured: true)
  ...
  b8 = Boat.new( name: "Queen's Gambit", lat: 38.0047, long: -122.9769, price: '2600', style: 'Sail', size: 8, user_id: 12, tagline: "A true beauty")
  ...
  b9 = Boat.new( name: "Heisenberg", lat: 38.0204, long: -122.8656, price: '10000', style: 'Budget', size: 4, user_id: 5, tagline: "Lot's of blue sky", featured: true)
  ...
  b10 = Boat.new( name: "Iron Boat Mark V", lat: 37.4945, long: -122.4683, price: '2500', style: 'Budget', size: 4, user_id: 6, tagline: "Simply the best")
