ActiveRecord::Base.transaction do
  ...
  User.create!( f_name: 'Elon', l_name:'Musk', email: 'elonmusk', password: 'apples', image_url:'https://www.filepicker.io/api/file/eDD9cNdBRNiNT0abUus1')
  #5
  User.create!( f_name: 'Walter', l_name:'White', email: 'heisenberg', password: 'apples', image_url:'https://www.filepicker.io/api/file/lb6dS6duQJSl4n2IEllU')
  User.create!( f_name: 'Tony', l_name:'Stark', email: 'irohman', password: 'apples', image_url:'https://www.filepicker.io/api/file/YcwCNyvtS8eyy2rSA9gW')
  ...
  User.create!( f_name: 'App', l_name:'Academy', email: 'giantrobot', password: 'apples', image_url:'https://www.filepicker.io/api/file/F6tvi2w5T3WpKSejIfjF')
  #10
  User.create!( f_name: 'Arthur', l_name:'Curry', email: 'aquaman', password: 'apples')
  User.create!( f_name: 'Bruce', l_name:'Wayne', email: 'bwayne', password: 'apples', image_url:'https://www.filepicker.io/api/file/EfnkTMjcQEurEMxP3JFv')
